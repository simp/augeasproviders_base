%define mod_name augeasproviders_base

Summary: Base resource Augeas-based providers for Puppet
Name: pupmod-augeasproviders_base
Version: 2.0.1
Release: 0
...
%description
This module provides providers for Puppet base types using the Augeas configuration API library.
